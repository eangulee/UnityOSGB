...
public class CameraMove : MonoBehaviour
{
    ...
    private void Start()
    {
        MRotationSpeed = sliderValue(PlayerPrefs.GetFloat("MRotationSpeed", 5));
        MMoveSpeed = sliderValue(PlayerPrefs.GetFloat("MMoveSpeed", 5));
        keySpeed = sliderValue(PlayerPrefs.GetFloat("keySpeed", 5));
